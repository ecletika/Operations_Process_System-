...
$router->post('/processes/{id}/transfer', [ProcessController::class, 'transfer'], [Authenticate::class, [PermissionMiddleware::class, 'process.transfer']]);
...
$router->get('/admin/sla-calendar', [AdministrationController::class, 'slaCalendar'], [Authenticate::class, [PermissionMiddleware::class, 'sla_calendar.manage']]);
$router->post('/admin/sla-calendar/hours', [AdministrationController::class, 'saveBusinessHours'], [Authenticate::class, [PermissionMiddleware::class, 'sla_calendar.manage']]);
$router->post('/admin/sla-calendar/holidays', [AdministrationController::class, 'storeHoliday'], [Authenticate::class, [PermissionMiddleware::class, 'sla_calendar.manage']]);
$router->post('/admin/sla-calendar/holidays/{id}/delete', [AdministrationController::class, 'deleteHoliday'], [Authenticate::class, [PermissionMiddleware::class, 'sla_calendar.manage']]);
$router->get('/admin/sla-reasons', [AdministrationController::class, 'slaReasons'], [Authenticate::class, [PermissionMiddleware::class, 'sla_reasons.manage']]);
$router->post('/admin/sla-reasons', [AdministrationController::class, 'storeSlaReason'], [Authenticate::class, [PermissionMiddleware::class, 'sla_reasons.manage']]);
$router->post('/admin/sla-reasons/{id}', [AdministrationController::class, 'updateSlaReason'], [Authenticate::class, [PermissionMiddleware::class, 'sla_reasons.manage']]);
$router->post('/admin/sla-reasons/{id}/delete', [AdministrationController::class, 'deleteSlaReason'], [Authenticate::class, [PermissionMiddleware::class, 'sla_reasons.manage']]);
$router->get('/admin/subject-departments', [AdministrationController::class, 'subjectDepartments'], [Authenticate::class, [PermissionMiddleware::class, 'subjects.manage']]);
$router->post('/admin/subject-departments/{id}', [AdministrationController::class, 'saveSubjectDepartments'], [Authenticate::class, [PermissionMiddleware::class, 'subjects.manage']]);
